...
<head>
	...
	<!-- Jquery -->
	<script src="{{ asset("assets/vendor/libs/fileman/js/jquery.min.js") }}"></script>
	<script>
		const confUrl = '{{ route('fileManager.config') }}';
		const assetsUrl = '{{ asset('assets/vendor/libs/fileman') }}/';
		const libUrl = '{{ url('assets/vendor/libs/fileman/') }}';
	...
	<link href="{{ asset('assets/vendor/libs/fileman/css/jquery-ui-1.10.4.custom.min.css') }}" rel="stylesheet" type="text/css"/>
	<link href="{{ asset('assets/vendor/libs/fileman/css/main.min.css') }}" rel="stylesheet" type="text/css"/>
	<script type="text/javascript" src="{{ asset('assets/vendor/libs/fileman/js/jquery-ui-1.10.4.custom.min.js') }}"></script>
	<script type="text/javascript" src="{{ asset('assets/vendor/libs/fileman/js/custom.js') }}"></script>
	<script type="text/javascript" src="{{ asset('assets/vendor/libs/fileman/js/mini-main.js') }}"></script>
	<script type="text/javascript" src="{{ asset('assets/vendor/libs/fileman/js/jquery-dateFormat.min.js') }}"></script>
</head>
<body>
	...
	<tr>
		<td valign="top" class="pnlDirs" id="dirActions">
			...
			<div id="pnlLoadingDirs">
				...
				<img src="{{ asset('assets/vendor/libs/fileman/images/loading.gif') }}" title="Loading directory tree, please wait...">
			</div>
			...
			<div class="pnlFiles">
				<div class="scrollPane">
					<div id="pnlLoading">
						...
						<img src="{{ asset('assets/vendor/libs/fileman/images/loading.gif') }}" title="Loading files, please wait...">
					</div>
