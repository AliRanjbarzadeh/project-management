		...
		<div class="col-12">
			<form action="{{ route('admins.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
				...
				<div class="row">
							...
							<div class="card-body">
								...
								<div class="row">
									<div class="col-md-4 mb-3">
										...
										<input type="text" class="form-control" id="firstname" name="firstname" placeholder="@lang('admin.placeholders.firstname')" value="{{ old('firstname') }}"/>
									</div>

									<div class="col-md-4 mb-3">
										<label for="lastname" class="form-label">@lang('admin.fields.lastname')</label>
										<input type="text" class="form-control" id="lastname" name="lastname" placeholder="@lang('admin.placeholders.lastname')" value="{{ old('lastname') }}"/>
									</div>

									<div class="col-md-4 mb-3">
										<label for="contact_number" class="form-label">@lang('admin.fields.contact_number')</label>
										<input type="text" class="form-control" id="contact_number" name="contact_number" placeholder="@lang('admin.placeholders.contact_number')" value="{{ old('contact_number') }}" data-type="number"/>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-4 mb-3">
										...
										<input type="text" class="form-control" id="username" name="username" placeholder="@lang('admin.placeholders.username')" value="{{ old('username') }}"/>
									</div>
					...
					<div class="col-md-4">
						<!--Feature Image-->
						@include('templates.feature-image')
