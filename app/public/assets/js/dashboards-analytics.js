...
!function () {
	...
	i = document.querySelector("#profileReportChart"), s = {chart: {height: 80, type: "line", toolbar: {show: !1}, dropShadow: {enabled: !0, top: 10, left: 5, blur: 3, color: config.colors.warning, opacity: .15}, sparkline: {enabled: !0}}, grid: {show: !1, padding: {right: 8}}, colors: [config.colors.warning], dataLabels: {enabled: !1}, stroke: {width: 5, curve: "smooth"}, series: [{data: [110, 270, 145, 245, 205, 285]}], xaxis: {show: !1, lines: {show: !1}, labels: {show: !1}, axisBorder: {show: !1}}, yaxis: {show: !1}};
	if (null !== i) {
		const l = new ApexCharts(i, s);
		l.render()
	}
	i = document.querySelector("#orderStatisticsChart"), s = {
		chart: {height: 165, width: 130, type: "donut"}, labels: ["الکترونیک", "ورزشی", "دکور", "فشن"], series: [85, 15, 50, 50], colors: [config.colors.primary, config.colors.secondary, config.colors.info, config.colors.success], stroke: {width: 5, colors: o}, dataLabels: {
			enabled: !1, formatter: function (o, t) {
				return parseInt(o) + "%"
			}
		}, legend: {show: !1}, grid: {padding: {top: 0, bottom: 0, right: 15}}, plotOptions: {
			pie: {
				donut: {
					size: "75%", labels: {
						show: !0, value: {
							fontSize: "1.5rem", fontFamily: "irsans", color: t, offsetY: -15, formatter: function (o) {
								return parseInt(o) + "%"
							}
						}, name: {offsetY: 20, fontFamily: "irsans"}, total: {
							show: !0, fontSize: "10px", fontFamily: "irsans", color: e, label: "هفتگی", formatter: function (o) {
								return "38%"
							}
						}
					}
